...
def on_new_bar(bars: BarDataList, has_new_bar: bool): 
    if has_new_bar: # cada vez que hay nuva barra:
        ...
        df['out_condition_1'] = df['close'] < (df['close'].shift(2) - 1.3 * df['atr_14'])
        ...
        # leemos el df_out
        df_out = pd.read_pickle('df_out_18.pkl')
        ...
        df_out.to_pickle('df_out_18.pkl')

...
data = ib.reqHistoricalData(
    contract,
    endDateTime='',
    durationStr='60000 S', # la duracion del historico requerido dependera del mayor de los parametros de los indicadores usados en la estrategia
...
def on_new_bar(bars: BarDataList, has_new_bar: bool): 
    if has_new_bar: # cada vez que hay nuva barra:
        ...
        df['in_condition_1'] = df['close'] > df['close'].shift(2) + 2 * df['atr_14']
        ...
        # leemos el df_out
        df_out = pd.read_pickle('df_out_6.pkl')
